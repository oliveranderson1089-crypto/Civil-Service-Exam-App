...
#
# **short（简答论述题）不是本地的题型。** 两套本地原卷上只有单选/多选/判断/案例/公文
# 五种，简答论述是外省题库带进来的（见 ingest_sqsub.py）。留着它是因为那 49 道题
# 本身是好的知识点自测材料，但界面上必须和本地考的四十分主观题**分开摆、标明白**，
# 不能让人以为本地会考简答 —— 卷面上没有的题型，混进「主观题 40 分」就是在编考情。
...
# 本地卷面**真有**的题型，按卷面顺序。整卷渲染、分部统计都按它排 ——
...
RULE_TEXT = {
    "single": "四选一，选对得分。",
    "multi": "多选、少选、错选均不得分 —— 与本地真题判分口径一致。",
