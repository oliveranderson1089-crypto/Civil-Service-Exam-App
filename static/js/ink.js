/* 文本锚 + 通用手写批注层（锚是批注的定位方式）
 *
 * 由 app.js 按它自己的区段边界切出（原 L9161-9913）。
 ...
 */
/* global $, ANN_SKIP, api, appConfirm, back, c,
   esc, hidePdfjsPen, hl, lsDel, lsGet, lsSet,
   mkNodes, mkPageRoot, mkText, mkWrapOne, padData, probeSlides,
   push, render, stack, toast */
